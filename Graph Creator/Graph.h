...
void Graph::insertEdge(char node1, char node2, int weight) {
    if (!contains(nodemap, node1) || !contains(nodemap, node2)) cout << "Some nodes were not found." << endl;
    else if (graph->at(indexOf(nodemap, node1))->at(indexOf(nodemap, node2)) == 0) graph->at(indexOf(nodemap, node1))->at(indexOf(nodemap, node2)) = weight;
...
void Graph::removeEdge(char node1, char node2) {
    if (!contains(nodemap, node1) || !contains(nodemap, node2)) cout << "Some nodes were not found." << endl;
    else if (graph->at(indexOf(nodemap, node1))->at(indexOf(nodemap, node2)) != 0) graph->at(indexOf(nodemap, node1))->at(indexOf(nodemap, node2)) = 0;
